...
remove_user_shortcuts() {
  ...
  remove_file "$home/.config/edulab/desktop-style-v26.done"
  remove_file "$home/.config/edulab/desktop-style-v27.done"
  remove_file "$home/.config/edulab/desktop-style-v28.done"
...
remove_system_helpers() {
  ...
  remove_file "/usr/local/bin/edulab-open-quick-settings"
